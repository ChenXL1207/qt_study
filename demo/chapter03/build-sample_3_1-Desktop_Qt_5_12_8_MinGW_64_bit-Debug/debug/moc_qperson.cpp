...
QT_MOC_LITERAL(5, 36, 7), // "version"
QT_MOC_LITERAL(6, 44, 3), // "1.0"
QT_MOC_LITERAL(7, 48, 10), // "ageChanged"
QT_MOC_LITERAL(8, 59, 0), // ""
QT_MOC_LITERAL(9, 60, 5), // "value"
QT_MOC_LITERAL(10, 66, 3), // "age"
QT_MOC_LITERAL(11, 70, 4), // "name"
QT_MOC_LITERAL(12, 75, 5) // "score"

    },
    "QPerson\0author\0Arxibye\0company\0NCHL\0"
    "version\0""1.0\0ageChanged\0\0value\0age\0"
    "name\0score"
};
...
void QPerson::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ageChanged((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QPerson::*)(unsigned  );
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< uint*>(_v) = _t->age(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->m_name; break;
        case 2: *reinterpret_cast< int*>(_v) = _t->m_scores; break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setAge(*reinterpret_cast< uint*>(_v)); break;
        case 1:
            ...
            break;
        case 2:
            if (_t->m_scores != *reinterpret_cast< int*>(_v)) {
                _t->m_scores = *reinterpret_cast< int*>(_v);
            }
            break;
        default: break;
        }
...
// SIGNAL 0
void QPerson::ageChanged(unsigned  _t1)
{
